...
RUN ["/bin/bash", "-c", ". /home/gitpod/anaconda3/etc/profile.d/conda.sh && conda create -n newton -c conda-forge nodejs=18.15.0 python=3.9 jupyterlab matplotlib seaborn lightgbm catboost -y"]
RUN conda init
